...
public:
	...
	bool Initialize() override // Now override the Initialize function so we can actually hook our stuff
	{
		...
		void* MouseAddr = Memory::findSig(xorstr_("48 8B C4 48 89 58 ? 48 89 68 ? 48 89 70 ? 57 41 54 41 55 41 56 41 57 48 83 EC ? 44 0F B7 BC 24")); // I actually forgot how to get this but it doesn't change often so np.
		...
		return Memory::HookFunction(MouseAddr, (void*)&MouseDetourHook, &onSendMouse, xorstr_("Mouse"));
